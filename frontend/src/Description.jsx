...
<br />
幸运的是，随着大型语言模型ChatGPT的问世，为了满足人们对书本内容的拓展需求，我决定使用大模型，运用Chain of Thought推理方法训练开源模型Mixtral-8x22B，以原作者的风格对五万个常用单词进行解释。在两张Nvidia 3090ti服务器上，整整跑了五天五夜，终于完成了对50000个单词的详细解释。
</p>
